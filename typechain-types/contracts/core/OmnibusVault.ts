...
export interface OmnibusVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "approveTx"
...
export interface OmnibusVault extends BaseContract {
  connect(runner?: ContractRunner | null): OmnibusVault;
  waitForDeployment(): Promise<this>;

  interface: OmnibusVaultInterface;
